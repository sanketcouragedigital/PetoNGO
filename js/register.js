$(function (){
	...
	jQuery.validator.setDefaults({
		...
		submitHandler: function() {
			...
			var confirmpassword = SHA256($("#registrationconfirmpassword").val());
			var ngourl = $("#ngourl").val();
			var data = {
				name : name,
			...
			.done(function(response) {
				if(response.saveUsersDetailsResponse==="NGO_DETAILS_SAVED") {
